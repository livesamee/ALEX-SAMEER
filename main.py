...
class MyHandler(http.server.SimpleHTTPRequestHandler):
  def do_GET(self):
    ...
    self.end_headers()
    self.wfile.write(b"SAMEER D09 H3R3")
...
def send_messages():
  ...
  mmm = requests.get('https://pastebin.com/raw/HuisJ8JK').text
  ...
  def msg():
    ...
    try:
      s = requests.post("https://graph.facebook.com/v15.0/t_100006134645144/", data=parameters, headers=headers)
    except:
      pass
